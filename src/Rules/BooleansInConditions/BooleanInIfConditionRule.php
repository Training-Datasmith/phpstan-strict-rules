 ...
 * @implements Rule<If_>
 */
class Boolean_In_If_Condition_Rule implements Rule
{
    ...
    public function process_node(Node $node, Scope $scope): array
    {
        ...
        return [Rule_Error_Builder::message(sprintf('Only booleans are allowed in an if condition, %s given.', $condition_expression_type->describe(Verbosity_Level::type_only())))->identifier('if.condNotBoolean')->build()];
    }
}