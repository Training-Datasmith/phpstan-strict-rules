 ...
 */
class Boolean_In_Do_While_Condition_Rule implements Rule
{
    ...
    public function process_node(Node $node, Scope $scope): array
    {
        ...
        return [Rule_Error_Builder::message(sprintf('Only booleans are allowed in a do-while condition, %s given.', $condition_expression_type->describe(Verbosity_Level::type_only())))->identifier('doWhile.condNotBoolean')->build()];
    }
}